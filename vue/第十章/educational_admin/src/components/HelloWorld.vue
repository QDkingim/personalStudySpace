  ...
  <el-container>
    ...
    <el-container>
      <el-aside width="200px">
        <el-menu default-active="1" class="el-menu-vertical-demo aside" @select="selectFunc" :unique-opened="true">
          <el-sub-menu index="1">
            <template #title>
              <span>七年级</span>
            </template>
      ...
      <el-container>
        ...
        <el-footer class="footer" height="30px">Vue框架搭建，ElementPlus提供组件支持</el-footer>
      </el-container>
    </el-container>
  </el-container>
</template>
